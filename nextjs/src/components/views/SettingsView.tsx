/**
 * Settings View
 * Shared body for the dashboard and org-scoped Settings pages
 */
...
export default function SettingsView() {
  ...
  useEffect(() => {
    ...
    if (router.query.checkout === 'success') {
      ...
      // Clear the query parameter (preserve dynamic slug segment in org context)
      const slug = router.query.slug as string | undefined;
      router.replace(
        slug ? { pathname: router.pathname, query: { slug } } : router.pathname,
        undefined,
        { shallow: true },
      );
    }
